					...
					<div class="pricing-entry d-flex ftco-animate">
						...
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								...
								<span class="price">RM <?php echo $dessert->price; ?></span>
							</div>
							<div class="d-block">
					...
					<div class="pricing-entry d-flex ftco-animate">
						...
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								...
								<span class="price">RM <?php echo $drink->price; ?></span>
							</div>
							<div class="d-block">
    ...
    <section class="ftco-menu mb-5 pb-5">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <p>A cup of rich, aromatic coffee paired with a delightful dessert – the perfect way to start or end your day! Come and experience the best of both worlds at Secangkir Coopitiam.</p>
          </div>
        </div>
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				...
		              				<div class="text">
		              					...
		              					<p><?php echo $drink->description; ?></p>
		              					<p class="price"><span>RM <?php echo number_format($drink->price, 2) ; ?></span></p>
								...
								<div class="col-md-4 text-center">
									<div class="menu-wrap">
										...
										<div class="text">
											...
											<p><?php echo $dessert->description; ?></p>
											<p class="price"><span>RM<?php echo number_format($dessert->price, 2) ; ?></span></p>
